...
def get_df(min_date, max_date, modes, resolution, aggregation_method):
    #print(min_date, max_date)
    df = (
        ridership_df.set_index('date')[modes]
...
table_body = [html.Tbody([
    html.Tr([
        html.Td("Ridership between 2001-01-01 and 2024-12-31"),
    ...
    html.Tr([
        html.Td(dbc.Row([
            dbc.Col(html.Div("Ridership between select dates"), width="auto"),
